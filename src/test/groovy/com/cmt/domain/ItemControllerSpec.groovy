...
class ItemControllerSpec extends Specification {
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        when:"The save action is executed with a valid instance"
            ...
            def store =new Store(storeName: 'Shopify-test',  address1:'AAAAAA',address2:'',city:'Madison',state:'WI',zip:'53719',typeofGoods:'Grocery,Handi-crafts')
            store.id = UUID.randomUUID();

            item = new Item(id:UUID.randomUUID(),catalogId: 'Boston-002',  descr:'Brass Jewelery',price:new Double(15.99),store:store)
